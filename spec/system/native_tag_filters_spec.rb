...
RSpec.describe "Native Tag Filters" do
  ...
  before do
    ...
    SiteSetting.discourse_native_tag_filters_enabled = true
    SiteSetting.discourse_native_tag_filters_legacy_all_word = "bananas"
  end
