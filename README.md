...
* Redirects legacy `/tags/intersection/...` links to native URLs.

### Settings

* Enable the plugin.
* Configure the legacy placeholder string used only when redirecting old `/tags/intersection/...` URLs.
